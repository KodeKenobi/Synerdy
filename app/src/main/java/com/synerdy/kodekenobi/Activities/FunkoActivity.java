...
public class FunkoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(FunkoActivity.this));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                ...
                .setQuery(reference.orderByChild("category").equalTo("funkopops")
                        , Products.class)
                .build();
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(FunkoActivity.this, ProductDetailsActivity.class);
