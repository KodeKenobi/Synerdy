...
import com.synerdy.kodekenobi.Model.Cart;
import com.synerdy.kodekenobi.Prevalent.Prevalent;
import com.synerdy.kodekenobi.ViewHolder.CartViewHolder;
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                holder.productName.setText(model.getPname());
                 //int oneTypeOfProductPrice = ((Integer.valueOf(model.getPrice()))) * Integer.valueOf(model.getQuantity());
                int oneTypeOfProductPrice =(Integer.parseInt(model.getPrice().replaceAll("\\D+",""))) * Integer.parseInt(model.getQuantity());
                                    ...
                                    cartListRef.child("User View")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task)
                                                {
                                                    ...
                                                    {
                                                        Toast.makeText(CartActivity.this, "Item removed successfully.", LENGTH_SHORT).show();
