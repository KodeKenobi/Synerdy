...
public class IndieBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indie_books);

        inputText = (EditText) findViewById(R.id.search_product_name);
        SearchBtn = (Button) findViewById(R.id.search_Product_btn);
        searchList = findViewById(R.id.search_list);
        searchList.setLayoutManager(new LinearLayoutManager(IndieBooksActivity.this));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                ...
                .setQuery(reference.orderByChild("category").equalTo("indies")
                        , Products.class)
                .build();
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(IndieBooksActivity.this, ProductDetailsActivity.class);
